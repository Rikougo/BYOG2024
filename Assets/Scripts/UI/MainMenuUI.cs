...
namespace TrashBoat.UI
{
	public class MainMenuUI : MonoBehaviour
	{
		...
		private Transform m_mainMenuLayout;

		[SerializeField] private Button m_startButton;
		[SerializeField] private Button m_creditsButton;
		[SerializeField] private Button m_exitButton;

		[Header("Credits")] [SerializeField] private Transform m_creditsLayout;
		...
		private void OnEnable()
		{
			...
			m_creditsButton.onClick.AddListener(() => ToggleCredits(true));
		...
		private void ToggleCredits(bool p_value)
		{
			...
			if (p_value)
				m_creditsBackButton.onClick.AddListener(() => ToggleCredits(false));
			else
